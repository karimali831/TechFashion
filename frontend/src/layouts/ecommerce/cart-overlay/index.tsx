import { Box, CircularProgress, Fade, Icon, LinearProgress } from "@mui/material";
                            ...
                            itemsInCart.map((item, idx) => {
                                ...
                                return (
                                    <Fade
                                        ...
                                        unmountOnExit={true}
                                        style={{
                                            transitionDelay: idx !== 0 ? idx * 100 + "ms" : "0ms",
                                        }}
                                    >
                                        <Box key={item.id} mb={4} display="flex">
                                            ...
                                            <Box display="flex" flexDirection="column" overflow="hidden" width="100%">
                                                ...
                                                {item.variantList.map((variant, idx) => (
                                                    <MDTypography variant="h7" color="text" key={idx}>
                                                        {variant.attribute}
                                                        {": " + variant.value}
                                                    </MDTypography>
                                                ))}
