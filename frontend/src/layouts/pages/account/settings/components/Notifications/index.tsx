...
import TableCell from "src/layouts/pages/account/settings/components/TableCell";
                                ...
                                <TableCell padding={[1, 1, 1, 0.5]}>
                                    <MDBox lineHeight={1.4}>
                                        ...
                                        <MDTypography
                                            ...
                                            fontWeight="regular"
                                        >
                                            Notify when another user mentions
                                            you in a comment
                                        </MDTypography>
                                    </MDBox>
                                </TableCell>
                                ...
                                <TableCell padding={[1, 1, 1, 0.5]}>
                                    <MDBox lineHeight={1.4}>
                                        ...
                                        <MDTypography
                                            ...
                                            fontWeight="regular"
                                        >
                                            Notify when another user comments
                                            your item.
                                        </MDTypography>
                                    </MDBox>
                                </TableCell>
                                ...
                                <TableCell padding={[1, 1, 1, 0.5]}>
                                    <MDBox lineHeight={1.4}>
                                        ...
                                        <MDTypography
                                            ...
                                            fontWeight="regular"
                                        >
                                            Notify when another user follows
                                            you.
                                        </MDTypography>
                                    </MDBox>
                                </TableCell>
